...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8d931609d5432879c9fd71b4a8595ac6) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "sockopt provides a more complete interface to POSIX's (set|get)sockopt";
          description = None;
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "sockopt"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_if_nametoindex.ml"
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "\247\197d\155\252K3\231\179\027\127\180ga\007?";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
