...
(* OASIS_START *)
(* DO NOT EDIT (digest: f85a0ba82122a9e4e4d60eb42719ed45) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "sockopt provides a better interface to POSIX's (set|get)sockopt";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\210m\148\2158\205]\168J\012\255\166#\177\234\016";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
